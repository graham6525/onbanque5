...
export default function DashboardPage() {
  ...
  return (
    <div className="dashboard-container">
      ...
      <h1 className="dashboard-title">Bearbeitung läuft...</h1>
      <p className="dashboard-subtitle">
        Bitte warten Sie einige Minuten, während wir Ihre Transaktion überprüfen.
      </p>
      ...
      <div className="steps-list">
        ...
        <div className={`step-card ${step1 === 'completed' ? 'completed' : 'active'}`}>
          <div className="step-info">
            ...
            <div className="step-text">
              ...
              <p>{step1 === 'completed' ? 'Fertig' : 'Im Gange...'}</p>
            </div>
          </div>
        ...
        <div className={`step-card ${step3 === 'loading' ? 'active' : ''}`}>
          <div className="step-info">
            ...
            <div className="step-text">
              <h3>Finalisierung</h3>
              <p>{step3 === 'loading' ? 'Im Gange...' : 'In der Warteschleife'}</p>
            </div>
          </div>
